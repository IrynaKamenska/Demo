...
public class Integrationtest {
    ...
    void searchApiBooksByIsbn_returnListWithOneBook() throws Exception {
        ...
        BookResponseElement mockBokListResponse = new BookResponseElement(List.of(book));
...
/*
        List<Book> mockWebServerResponse = new ArrayList<>();
        mockWebServer.enqueue(new MockResponse()
                .setBody("[]")
                        .addHeader("Content-Type", "application/json")
                );
*/
                ...
                mockMvc.perform(MockMvcRequestBuilders.get("/api/books/isbn/abc"))
                        ...
                        .andExpect(status().reason("can't parse argument number:"));
            }
